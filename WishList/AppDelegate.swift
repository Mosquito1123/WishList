...
public class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "Listr", withExtension: "momd")! // type your database name here..
    ...
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = applicationDocumentsDirectory.appendingPathComponent("Listr.sqlite") // type your database name here...
